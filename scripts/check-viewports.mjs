 ...
 *
 *   node scripts/check-viewports.mjs /shabaneh/products/
 */
...
const path = args[0] ?? "/shabaneh/products/";
...
for (const width of VIEWPORTS) {
  ...
  await page.evaluate(async () => {
    ...
    // A reveal takes --dur-band (1400ms) to finish. Measuring opacity the instant
